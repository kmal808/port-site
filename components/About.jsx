		...
		<div id='about' className='w-full md:h-screen p-2 flex items-center py-16'>
			<div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
				<div className='col-span-2'>
					<p className='uppercase font-bold text-xl tracking-widest text-teal-600'>
						About
					</p>
					<h2 className='py-4 text-3xl sm:text-4xl'>Get To Know Me</h2>
					{/* //ToDo decide on a sub heading */}
					<h4 className='py-4 font-bold'>Who I Am</h4>
					<p className='py-2 text-gray-600 dark:text-slate-100'>
					...
					<h4 className='py-4 font-bold'>Where I&apos;m At</h4>
					<p className='py-2 text-gray-600 dark:text-slate-100'>
						🌎 Located on the island of Oahu, Hawaii
					</p>
					<h4 className='py-4 font-bold'>What I Do</h4>
					<p className='py-2 text-gray-600 dark:text-slate-100'>
					...
					<h4 className='py-4 font-bold'>How I Do It</h4>
					<p className='py-2 text-gray-600 dark:text-slate-100'>
						{/* //ToDo finish this section  */}
					...
					<Link href='/#projects'>
						<p className='py-5 text-gray-600 dark:text-slate-100 underline cursor-pointer'>
