			...
			<div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
				<div className='col-span-4'>
					...
					<p>
						...
						correlates to the document known as The Bank amongst my fellow
						100Devs. The buttons below the text field will retrieve a random
						question and answer for whichever category button is selected. This
						app can also serve as an API endpoint for other frontend
						applications to build upon. This was originally written in vanilla
						node but then later wasa rewritten using Express.
					</p>
					<a
